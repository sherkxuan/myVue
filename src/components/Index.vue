...
import 'tinymce/plugins/axupimgs'  //批量上图片 
export default {
      name: 'TEditor',
      components: {
            Editor
      ...
      props: {
            ...
            plugins: {
                  type: [String, Array],
                  default: 'table image preview fullscreen lists link quickbars axupimgs'
            },
            toolbar: {
                  type: [String, Array],
                  default: 'preview fullscreen undo redo|alignleft aligncenter alignright alignjustify outdent indent|\
                  bold italic underline strikethrough subscript superscript|table image axupimgs|forecolor backcolor|\
                  fontselect fontsizeselect lineheight|bullist numlist'
            },
            placeholder:{
                  type: String,
                  default: '在这里输入文字'
      ...
      data(){
             return {
                  init: {
                        language_url: '/tinymce/langs/zh_CN2.js',  //引入语言包文件
                        language: 'zh_CN2',  //语言类型
